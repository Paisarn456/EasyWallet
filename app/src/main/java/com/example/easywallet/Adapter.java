...
import android.view.LayoutInflater;
        ...
        import com.example.easywallet.model;
...
public class PhoneListAdapter extends ArrayAdapter<Model> {

    private Context mContext;
    private int mLayoutResId;
    private ArrayList<Model> mItemList;

    public PhoneListAdapter(@NonNull Context context, int layoutResId, @NonNull ArrayList<Model> phoneItemList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Model item = mItemList.get(position);
        ...
        phoneNumberTextView.setText(item.money);
